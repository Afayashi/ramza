...
const TEMPLATES = [
  ...
  { id: 'property_report', title: 'تقرير عقار', description: 'تقرير شامل عن عقار', icon: Building2, color: '#8b5cf6' },
        ...
        {TEMPLATES.map(t => (
          <div key={t.id}
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" className="flex-1 text-[10px] h-7" onClick={(e) => { e.stopPropagation(); handlePrint(t.id); }}>
