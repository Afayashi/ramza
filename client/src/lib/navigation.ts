...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'العقارات — عرض رمز الإبداع', path: '/buildings' },
      { label: 'الوحدات', path: '/units' },
      { label: 'العقود المؤرشفة', path: '/contracts/archived' },
      { label: 'وثائق الملكية', path: '/ownership-docs' },
    ],
  },
  {
    label: 'المستأجرون',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'الملخص المالي المتكامل', path: '/finance' },
      { label: 'حسابات الملاك', path: '/finance/owners' },
      { label: 'حوالات منصة إيجار', path: '/finance/ejar-transfers' },
      { label: 'مالية العقود', path: '/finance/contract-financials' },
    ],
  },
  {
    label: 'الصيانة',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'تقرير الدفعات', path: '/reports/payments' },
      { label: 'تقرير العقود', path: '/reports/contracts' },
      { label: 'تقرير خسارة الشواغر', path: '/reports/vacancy' },
      { label: 'تقرير ربحية مالك', path: '/reports/owner-profitability' },
      { label: 'ربحية المكتب', path: '/reports/office-profitability' },
    ],
  },
  {
    label: 'العمليات',
    ...
    items: [
      ...
      { label: 'طلبات العملاء', path: '/crm/requests' },
      { label: 'العروض العقارية', path: '/crm/offers' },
      { label: 'سجل إرسال الواتساب', path: '/whatsapp-history' },
      { label: 'طلبات المستأجرين', path: '/whatsapp/requests' },
      { label: 'إيصالات السداد', path: '/payment-receipts' },
      { label: 'مركز المتابعات', path: '/follow-ups' },
      { label: 'التقويم الموحّد', path: '/calendar' },
      { label: 'المساعد الذكي', path: '/ai-assistant' },
      { label: 'رادار المخاطر', path: '/risk-radar' },
      { label: 'فاحص صحة المكتب', path: '/office-health' },
      { label: 'مهامي', path: '/tasks' },
      { label: 'مهام الموظفين', path: '/tasks/team' },
      { label: 'الفوترة الإلكترونية', path: '/zatca' },
    ],
  },
  {
    label: 'الإعدادات',
    ...
    items: [
      ...
      { label: 'معلومات الاشتراك والتجديد', path: '/settings/subscription' },
      { label: 'إعدادات الرسائل النصية', path: '/settings/sms' },
      { label: 'السياسات والشؤون القانونية', path: '/legal' },
      { label: 'هوية المكتب', path: '/settings/branding' },
      { label: 'إشعار السداد', path: '/settings/notice' },
      { label: 'صياغة الوثائق', path: '/settings/documents' },
    ],
  },
];
